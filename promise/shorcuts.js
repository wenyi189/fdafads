/*
'use strict'
let promise = Promise.resolve(console.log('This is fulfilled')).catch((err) => {
  console.log('A error appeared');
});

let secondPromise = Promise.reject(new Error('SECRET VALUE'));
*/
